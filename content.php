			...
			<div class="article" id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
				...
				<div class="entry-content">
					<?php
						...
						the_content( sprintf(
							__( 'Continue reading %s <span class="meta-nav">&rarr;</span>', 'huhanlin' ),
					...
					<?php
						wp_link_pages( array(
							'before' => '<div class="page-links">' . __( 'Pages:', 'huhanlin' ),
							'after'  => '</div>',
						) );
					?>
				</div><!-- .entry-content -->
